      ...
      <div className="flex items-center justify-between h-24 px-8 sm:px-10 lg:px-12">
        ...
        <div className="flex items-center gap-5">
          ...
          <Button 
            ...
            size="icon" 
            onClick={logout}
            className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors duration-200 h-10 w-10"
            title="Sign out"
          >
          ...
          {/* User Avatar */}
          <div className="h-10 w-10 rounded-full bg-indigo-600 text-white flex items-center justify-center font-semibold text-base cursor-pointer hover:bg-indigo-700 transition-colors duration-200" title={user?.email || 'User'}>
